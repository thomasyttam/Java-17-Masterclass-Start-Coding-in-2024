...
//        } catch (FileNotFoundException e) { // remove this exception as FileNotFoundException is child of IOException
//            throw new RuntimeException(e);
    ...
    private static Player readObject(Path dataFile) {
        try (ObjectInputStream objStream =
            ...
            return (Player) objStream.readObject(); // cast to Player
        } catch (IOException | ClassNotFoundException e) { // either one error
            throw new RuntimeException(e);
        }
    }
}
