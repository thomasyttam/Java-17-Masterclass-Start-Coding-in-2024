...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // above setting not change the May5 value as it is immutable
        System.out.println(May5);
        ...
        LocalTime sevenThirtyNano = LocalTime.of(7, 35, 15, 5812340);
        System.out.println(sevenThirtyNano);

//        LocalTime sevenPM = LocalTime.parse("7:00"); // cannot use 7:00, must use 07 for am, 19 for pm
        LocalTime sevenPM = LocalTime.parse("19:00"); // hour: 00 to 23, minutes: 00 to 59
        LocalTime sevenThirtyPM = LocalTime.parse("19:30:15.1000");
//        System.out.println(sevenPM);
//        System.out.println(sevenThirtyPM);
        System.out.println(sevenPM.get(ChronoField.AMPM_OF_DAY)); // 0 -> AM, 1 -> PM
...
//        System.out.println(sevenThirtyPM.get(ChronoField.YEAR)); // error as sevenThirtyPM don't have YEAR
//        System.out.println(sevenThirtyPM.plus(1, ChronoUnit.DAYS)); // error as sevenThirtyPM don't have DAY
        System.out.println(sevenThirtyPM.plus(24, ChronoUnit.HOURS));
        System.out.println(sevenThirtyPM.plus(3, ChronoUnit.HOURS));
        ...
        DateTimeFormatter dtf = DateTimeFormatter.ofLocalizedDate(FormatStyle.FULL); // datetime format base on location
