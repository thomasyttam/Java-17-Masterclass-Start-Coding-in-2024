...
//        return engagementMap; // change to defensive copy below
    ...
    public int getMonthsSinceActive() {
        ...
        // check all courseCode in engagementMap
    ...
    private static Course[] getRandomSelection(Course... courses) {
        ...
        int courseCount = random.nextInt(1, courses.length + 1); // get Random number of course from 1 to all courses
