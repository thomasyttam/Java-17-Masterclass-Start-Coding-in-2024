...
public class MainCollect {
    ...
    public static void main(String[] args) {
        ...
        Set<Student> youngAussies2 = students.stream()
                .filter((s) -> s.getAgeEnrolled() < 30)
                .filter((s) -> s.getCountryCode().equals("AU"))
//                .sorted() // below toSet() is not in order
//                .collect(Collectors.toSet()); // toSet is not in order
//                .collect(TreeSet::new, TreeSet::add, TreeSet::addAll); // Student is not comparable
