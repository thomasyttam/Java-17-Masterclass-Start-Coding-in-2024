...
public class Child extends Parent {
    ...
    private final int birthOrder = getBirthOrder(); // birthOrder must initialize before birthOrderString as birthOrderString use birthOrder
...
//        super(); // no "no argument" constructor in parent
    ...
    private final int getBirthOrder() {
        ...
        System.out.println("Calling getBirthOrder Function"); // check when this function is call
