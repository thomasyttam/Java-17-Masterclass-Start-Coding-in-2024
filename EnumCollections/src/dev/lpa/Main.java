...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Set<WeekDay> newPersonDays = EnumSet.complementOf(annsDaysSet); // complementOf get the remaining enum set
        System.out.println("---------------------");
        newPersonDays.forEach(System.out::println);

        Set<WeekDay> anotherWay = EnumSet.copyOf(allDaysSet);
        anotherWay.removeAll(annsDaysSet); // remove the enum same as annsDaySet
        System.out.println("---------------------");
