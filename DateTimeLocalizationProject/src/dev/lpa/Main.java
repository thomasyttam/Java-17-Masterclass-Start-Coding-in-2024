...
public class Main {
    ...
    private static Map<LocalDate, List<ZonedDateTime>> schedule(Employee first,
        ...
        LocalDate startingDate = LocalDate.now().plusDays(2); // not current date which Joe is 14 hours ahead for Jane
